...
print(f"{c.blue('#######################################')}")
print(f"{c.blue('#                                     #')}")
print(f"{c.blue('#    {c.red('CRIPTOGRAFIA - CIFRA DE CESAR')}    {c.blue('#')}")
print(f"{c.blue('#                                     #')}")
print(f"{c.blue('#######################################')}")

while True:
    print(f"{t.tagn1_yellow} {c.cyan('Criptografar')}")
    print(f"{t.tagn2_yellow} {c.cyan('Descriptografar')}")
    print(f"{t.tagn3_yellow} {c.cyan('Informações')}")
    print(f"{t.tagn4_yellow} {c.cyan('Sair')}")
    opcao = int(input(f"{t.hashtag_yellow} {c.cyan('Escolha a opção desejada: ')}"))
